...
$(function() {
    ...
    $("#frm_webinarsetup").validate({
        ...
        submitHandler: function(form)
        {
			...
			var msg = ' <p> IMPORTANT: If you wish to use the "360training" webinar provider, your course must be offered for distribution on the 360training networks. After the initial publish of this webinar, please click the Make Offer tab, and submit this webinar as an offer.</p> <p>If you do not wish to offer this webinar for distribution, please select "Others" as your webinar provider, and fill in the information of your own webinar provider. Note that you can still make an offer on a webinar using a non-360training webinar provider.</p></br><p>Continue with Save?</p>';

...
$.extend( true, $.fn.dataTable.defaults, {
	//"sDom": "<'row'<'col-md-6 table-L-actions'l><'col-md-6 table-R-actions'f>r><'table-scrollable't><'row'<'col-md-5 col-sm-12'i><'col-md-7 col-sm-12'p>>",
	//"sDom": "<'grid_actions row'<'col-xs-12 table-L-actions'l><'table-R-actions'f>r><'table-scrollable't><'row'<'col-sm-5'i><'col-sm-7'p>>",
	"sDom": "<'row'<'col-xs-12 table-tools-bar'l f r>><'table-scrollable't><'row'<'col-sm-5'i><'col-sm-7'p>>",

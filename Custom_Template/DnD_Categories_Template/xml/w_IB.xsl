		...
		<div class="portlet portlet-btn">
		  ...
		  <div class="portlet-body">
			<div role="alert" class="alert alert-warning">
				<i class="icon-warning-sign"></i> Each row represents a draggable object. Click the Add Row button ( <span class="btn btn-default btn-sm" disabled="disabled"><i class="icon-plus"></i></span> ) to add rows. With two categories, you can fit four objects in each category. With three categories, you can fit three objects in each category.
			</div>
			<div class="form-body">
			   <div class="form-group">
